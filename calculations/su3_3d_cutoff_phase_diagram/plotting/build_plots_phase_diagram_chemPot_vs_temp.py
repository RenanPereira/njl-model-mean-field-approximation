...
# Axes labels
ax.set_xlabel(r'$\mu_q \, [\mathrm{GeV}]$', fontsize=labels_fontsize)
...
configure_axes(ax, xmin, xmax, ymin, ymax, x_num_ticks=5, y_num_ticks=5, tick_fontsize=tick_fontsize, spine_width=1.5, tick_width=1.5, tick_length=6)
