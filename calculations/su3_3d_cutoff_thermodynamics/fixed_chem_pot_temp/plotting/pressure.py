...
def plot_pressure_vs_temperature(
    ...
    """
    This function plots the pressure vs temperature from FixedChemPotTempData.
...
def plot_pressure_vs_baryon_chem_pot(
    fig_dpi: int,
    fig_x_size: int,
    fig_y_size: int,
    data_specs: list[tuple[str, str, str, int, str]],
    ...
    """
    This function plots the pressure vs baryon chemical potential from FixedChemPotTempData.
    
    data_specs:
        List of tuples defining datasets and plot styles:
        (filepath, label, color, linewidth, linestyle)
    """
    print("Building plot: pressure versus baryon chemical potential.")
    print_unique_filepaths(data_specs)
