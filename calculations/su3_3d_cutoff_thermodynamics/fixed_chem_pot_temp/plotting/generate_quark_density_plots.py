...
plot_quark_dens_vs_chem_pot(
    ...
    "up_quark",
    path_plots_folder + "rho_quarks_vs_mu_setB_T0p12.png",
    "upper left",
    xlim=(0.0, 0.500),
    ylim=(0.0, 2.0),
    x_num_ticks=6,
...
plot_quark_dens_vs_chem_pot(
    ...
    "up_quark",
    path_plots_folder + "rho_quarks_vs_mu_setC_T0p13.png",
    "upper left",
    xlim=(0.0, 0.500),
    ylim=(0.0, 2.0),
    x_num_ticks=6,
...
plot_baryon_dens_vs_baryon_chem_pot(
    ...
    path_plots_folder + "rhoB_vs_muB_setB_T0p12.png",
    None,
    xlim=(0.0, 1.500),
    ylim=(0.0, 2.0),
    x_num_ticks=7,
...
plot_baryon_dens_vs_baryon_chem_pot(
    ...
    path_plots_folder + "rhoB_vs_muB_setC_T0p13.png",
    None,
    xlim=(0.0, 1.500),
    ylim=(0.0, 2.0),
    x_num_ticks=7,
...
plot_baryon_dens_dPdmuB_vs_baryon_chem_pot(
    ...
    path_plots_folder + "rhoB_dPdmuB_vs_muB_setB_T0p12.png",
    "upper left",
    xlim=(0.0, 1.500),
    ylim=(0.0, 2.0),
    x_num_ticks=7,
...
plot_baryon_dens_dPdmuB_vs_baryon_chem_pot(
    ...
    path_plots_folder + "rhoB_dPdmuB_vs_muB_setC_T0p13.png",
    "upper left",
    xlim=(0.0, 1.500),
    ylim=(0.0, 2.0),
    x_num_ticks=7,
