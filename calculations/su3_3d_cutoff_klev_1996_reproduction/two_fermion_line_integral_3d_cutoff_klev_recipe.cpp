...
double integrate_QAGP_PRO(
    string integral_ID, 
    double x_init, 
    vector<double> singular_points, 
    double x_final, 
    void* params, 
    double placeholder_f (double, void*), 
    int workspace_size, 
...
////////////////////////////////////////////////////////////
// This is based on mark_16 of the ancient codebase
...
double IntB0RehbergKlevanskypkfinTfinRe(double lambdax, double Mi, double Mj, double k, double Lambda, double T, double Cp)
{
    ...
    for (int i=0; i<int(auxpolos.size()); i++)
    {
