...
cp bin/nambuJonaLasinioModel.out calculations/su3_3d_cutoff_int_cross_sections/cep_chem_pot/data

cd calculations/su3_3d_cutoff_int_cross_sections/cep_chem_pot/data
