...
Run the scripts inside the folders (e.g., `zero_chem_pot`) to compile the C++ code, execute it using the provided configuration files, and generate the data files. For instance, inside the folder `zero_chem_pot`, you can find:
