...
datasets_cpcep = [
    (
        path_transport_data_folder + "SeebeckSigmaeProduct_setA_COMPLETE_COV_CP0p318436.dat", 
...
fig, ax = plot_seebeck_vs_temp(
    ...
    fig_y_size,
    datasets_cpcep,
    path_output_plot_folder + "seebeck_vs_temp_setA_CP0p318436.png",
    "upper right",
    xlim=(0.040, 0.300),
    ylim=(-9.0, 0.0),
    x_num_ticks=5,
...
fig, ax = plot_seebeck_vs_temp(
    ...
    [
        (
            path_transport_data_folder + "SeebeckSigmaeProduct_setB_COMPLETE_COV_CP0p231030.dat", 
    ...
    path_output_plot_folder + "seebeck_vs_temp_setB_CP0p231030.png",
    "upper right",
    xlim=(0.075, 0.300),
    ylim=(-12.0, 0.0),
    x_num_ticks=6,
...
fig, ax = plot_seebeck_vs_temp(
    ...
    [
        (
            path_transport_data_folder + "SeebeckSigmaeProduct_setC_COMPLETE_COV_CP0p164012.dat", 
    ...
    path_output_plot_folder + "seebeck_vs_temp_setC_CP0p164012.png",
    "upper right",
    xlim=(0.084, 0.300),
    ylim=(-15.0, 0.0),
    x_num_ticks=5,
