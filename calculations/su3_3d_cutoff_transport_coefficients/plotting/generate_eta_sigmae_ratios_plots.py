...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setA_CP0p0.png",
    "upper right",
    xlim=(0.120, 0.300),
    ylim=(9.0, 18),
    x_num_ticks=4,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    datasets_cp0,
    "su3_3d_cutoff_thermodynamics/fixed_chem_pot_temp/data/SU3NJL3DCutoffFixedChemPotTemp_setA_TMin0p0_TMax0p5_CPU0p0.dat",
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setA_CP0p0_zoom.png",
    "upper right",
    xlim=(0.200, 0.225),
    ylim=(10.3, 10.8),
    x_num_ticks=6,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    fig_y_size,
    datasets_cp0,
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setA_CP0p0.png",
    "upper right",
    xlim=(0.120, 0.300),
    ylim=(130, 180),
    x_num_ticks=4,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    fig_y_size,
    datasets_cp0,
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setA_CP0p0_zoom.png",
    "upper right",
    xlim=(0.200, 0.225),
    ylim=(135, 140),
    x_num_ticks=6,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setA_CP0p318436.png",
    "upper right",
    xlim=(0.040, 0.300),
    ylim=(4.0, 12),
    x_num_ticks=5,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    fig_y_size,
    datasets_cpcep,
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setA_CP0p318436.png",
    "upper right",
    xlim=(0.040, 0.300),
    ylim=(150, 300),
    x_num_ticks=5,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    fig_y_size,
    datasets_cpcep,
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setA_CP0p318436_zoom.png",
    "upper right",
    xlim=(0.065, 0.070),
    ylim=(288, 300),
    x_num_ticks=6,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setB_CP0p0.png",
    "upper right",
    xlim=(0.120, 0.300),
    ylim=(9.0, 18),
    x_num_ticks=4,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    "su3_3d_cutoff_thermodynamics/fixed_chem_pot_temp/data/SU3NJL3DCutoffFixedChemPotTemp_setB_TMin0p0_TMax0p5_CPU0p0.dat",
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setB_CP0p0_zoom.png",
    "upper right",
    xlim=(0.168, 0.180),
    ylim=(10.6, 10.9),
    x_num_ticks=4,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setB_CP0p0.png",
    "upper right",
    xlim=(0.120, 0.300),
    ylim=(130, 180),
    x_num_ticks=4,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setB_CP0p0_zoom.png",
    "upper right",
    xlim=(0.160, 0.180),
    ylim=(134, 140),
    x_num_ticks=6,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setB_CP0p231030.png",
    "upper right",
    xlim=(0.075, 0.300),
    ylim=(4.0, 28),
    x_num_ticks=6,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setB_CP0p231030.png",
    "upper right",
    xlim=(0.040, 0.300),
    ylim=(130, 300),
    x_num_ticks=5,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setB_CP0p231030_zoom.png",
    "upper right",
    xlim=(0.097, 0.102),
    ylim=(180, 220),
    x_num_ticks=6,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setC_CP0p0.png",
    "upper right",
    xlim=(0.120, 0.300),
    ylim=(9.0, 18),
    x_num_ticks=4,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    "su3_3d_cutoff_thermodynamics/fixed_chem_pot_temp/data/SU3NJL3DCutoffFixedChemPotTemp_setC_TMin0p0_TMax0p5_CPU0p0.dat",
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setC_CP0p0_zoom.png",
    "upper right",
    xlim=(0.148, 0.160),
    ylim=(10.8, 11.4),
    x_num_ticks=6,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setC_CP0p0.png",
    "upper right",
    xlim=(0.120, 0.300),
    ylim=(130, 180),
    x_num_ticks=4,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setC_CP0p0_zoom.png",
    "upper right",
    xlim=(0.140, 0.170),
    ylim=(134, 140),
    x_num_ticks=6,
...
fig, ax = plot_eta_temp_over_sigmae_s_vs_temp(
    ...
    path_output_plot_folder + "eta_temp_over_sigmae_s_vs_temp_methods_setC_CP0p164012.png",
    "upper right",
    xlim=(0.084, 0.300),
    ylim=(4.0, 36),
    x_num_ticks=5,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setC_CP0p164012.png",
    "upper right",
    xlim=(0.084, 0.300),
    ylim=(130, 300),
    x_num_ticks=5,
...
fig, ax = plot_eta_over_sigmae_temp2_vs_temp(
    ...
    path_output_plot_folder + "eta_over_sigmae_temp2_vs_temp_methods_setC_CP0p164012_zoom.png",
    "upper right",
    xlim=(0.109, 0.120),
    ylim=(150, 210),
    x_num_ticks=6,
