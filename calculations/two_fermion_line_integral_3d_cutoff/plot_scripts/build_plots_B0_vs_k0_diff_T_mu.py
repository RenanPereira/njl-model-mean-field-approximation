...
ax.plot(data_B0_vs_k0_T00_mu00.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T00_mu00.get_Re_B0(), 
        label=r'$\mathrm{Re}[B_0]$', color=colorT00, linewidth=2, linestyle='-')
ax.plot(data_B0_vs_k0_T00_mu00.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T00_mu00.get_Im_B0(), 
        label=r'$\mathrm{Im}[B_0]$', color=colorT00, linewidth=2, linestyle='--')

ax.plot(data_B0_vs_k0_T03_mu06.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T03_mu06.get_Re_B0(), 
        label=r'$\mathrm{Re}[B_0]$', color=colorT03, linewidth=2, linestyle='-')
ax.plot(data_B0_vs_k0_T03_mu06.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T03_mu06.get_Im_B0(), 
        label=r'$\mathrm{Im}[B_0]$', color=colorT03, linewidth=2, linestyle='--')

ax.plot(data_B0_vs_k0_T05_mu08.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T05_mu08.get_Re_B0(), 
        label=r'$\mathrm{Re}[B_0]$', color=colorT05, linewidth=2, linestyle='-')
ax.plot(data_B0_vs_k0_T05_mu08.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T05_mu08.get_Im_B0(), 
        label=r'$\mathrm{Im}[B_0]$', color=colorT05, linewidth=2, linestyle='--')

ax.plot(data_B0_vs_k0_T10_mu10.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T10_mu10.get_Re_B0(), 
        label=r'$\mathrm{Re}[B_0]$', color=colorT10, linewidth=2, linestyle='-')
ax.plot(data_B0_vs_k0_T10_mu10.get_momentum_to_Lambda_ratio(), 
        data_B0_vs_k0_T10_mu10.get_Im_B0(), 
...
xmin= 0; xmax = 2.5; ymin = -4.0; ymax = 4.0
...
auxH = 0.065; auxX = 0.030; auxY = 0.74 + auxH
texts = [
...
del data_B0_vs_k0_T00_mu00, data_B0_vs_k0_T03_mu06, data_B0_vs_k0_T05_mu08, data_B0_vs_k0_T10_mu10, plotname, dist
del colorT00, colorT03, colorT05, colorT10
del fig, ax, auxH, auxX, auxY, xmin, xmax, ymin, ymax


####################################################################################################
# B0 vs k0, M1=M2, k=0.5 GeV, different T and mu1=mu2 with Mass Shift
...
####################################################################################################
# B0 vs k0, M1=M2, k=1.0 GeV, different T and mu1=mu2 with Mass Shift
...
####################################################################################################
# B0 vs k0, M1=M2, k=1.5 GeV, different T and mu1=mu2 with Mass Shift
